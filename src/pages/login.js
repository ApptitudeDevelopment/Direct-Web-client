            ...
            <Grid container className={classes.form}>
                ...
                <Grid item sm>
                    ...
                    <form noValidate onSubmit={this.handleSubmit}>
                        ...
                        <TextField id="password" name="password" type="password" label="Password" className={classes.textField} helperText={errors.password} error={errors.email ? true : false} value={this.state.password} onChange={this.handleChange} fullWidth/>
                        {errors.general && (
                        ...
                        <br/>
                        <br/>
                        <small>Don't have an account? <Link to="/signup">Sign up right now!</Link></small>
                    </form>
                </Grid>
                <Grid item sm/>
            </Grid>
