...
const stripePromise = loadStripe("pk_test_51HHJLwBdInbw5VJ1r395gDYvoBs9jij76LzGH9axGWOwx8jrZsws5U1FCEtwzZLsbDMmDhxYiBAWVIKfEo5JfJaf00x2P3yR9a");
            ...
            <Grid container className={classes.form}>
                ...
                <Grid item sm>
                    ...
                    <form noValidate onSubmit={this.handleSubmit}>
                        ...
                        <br/>
                        <br/>
                        <small>Already have an account? <Link to="/login">Login right now!</Link></small>
                    </form>
                </Grid>
                <Grid item sm/>
            </Grid>
